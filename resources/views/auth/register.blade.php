      ...
      <section class="min-h-screen mb-32">
          ...
          <div class="container z-10">
            <div class="flex flex-wrap justify-center -mx-3">
              <div
                ...
                <p class="text-white">
                  Register now to access all features and manage your account easily.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="flex flex-wrap -mx-3 -mt-48 md:-mt-56 lg:-mt-48">
              <div
                class="relative w-1/2 z-0 flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border max-w-xl mx-auto">
                <div
                ...
                <div class="flex-auto p-6">
                 <form method="POST" action="{{ route('register') }}">
                        ...
                        <p
                          class="offset-md-1 mt-4 mb-0 leading-normal text-sm">
                            Already have an account?
                             <a
                                 href="{{route('login')}}"
                                 class="font-bold text-slate-300">Login</a>
                         </p>
                    </form>
