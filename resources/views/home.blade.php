...
@section('content')
 <main
      class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200 flex-grow">
      <!-- Navbar -->
      <nav
    ...
    <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        ...
        <nav>
            <h1 class="mb-0 mt-3 font-bold capitalize">Dashboard</h1>
        </nav>

        <div class="flex mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            <!-- Search Bar -->
              <div class="ms-auto mt-1" style="max-width: 300px;">
        ...
        <!-- User Dropdown -->
         ...
         <!-- Dropdown Button -->
            <!-- <button class="dropdown-toggle px-4 py-2 text-white font-bold rounded-2xl bg-primary shadow-soft-md hover:scale-102 transition-all"
                        type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        {{ Auth::user()->name }} ({{ Auth::user()->role }})
             </button> -->
                  <div class="relative">
                    <button dropdown-trigger aria-expanded="false" type="button" class="inline-block px-6 py-3 mr-3 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-purple-700 to-pink-500 leading-pro text-sm ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs">{{ Auth::user()->name }} ({{ Auth::user()->role }})</button>
                    <p class="hidden transform-dropdown-show"></p>
                    <ul dropdown-menu class="z-2 text-sm lg:shadow-soft-3xl duration-250 before:duration-350 before:font-awesome before:ease-soft min-w-44 before:text-5.5 transform-dropdown pointer-events-none absolute left-auto top-0 m-0 -mr-4 mt-2 list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-0 py-2 text-left text-slate-500 opacity-0 transition-all before:absolute before:right-7 before:left-auto before:top-0 before:z-40 before:text-white before:transition-all before:content-['\f0d8']">
                     <li>
                     ...
                     <li>
                            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="dropdown-item text-white bg-danger rounded-md" id="logout-button">
                                    Logout
                                </button>
                            </form>
                        </li>
            ...
            <!-- Mobile Hamburger -->
            <li class="flex items-center pl-4 xl:hidden list-none">
            ...
            <!-- Settings Cog -->
            <li class="flex items-center px-4 list-none">
...
document.getElementById('logout-button').addEventListener('click', function(e) {
    ...
    if (confirm("Are you sure you want to logout?")) {
      ...
      <div class="w-full px-6 py-6 mx-auto">
              ...
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p
                        class="mb-0 font-sans text-xl font-bold font-semibold leading-normal">
                        Students
                      </p>
            ...
            <div
              ...
              <div
                ...
                <p class="text-sm leading-normal">
                  ...
                  <span class="font-semibold">4% more</span> in Aug 2025
                </p>
              </div>
              <div class="flex-auto p-4">
                <div>
        ...
        <footer class="absolute bottom-0 left-0 w-full pt-4">
            ...
            <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
              <div
                ...
                <div
                  ...
                  made with ❤️ by
                  <a
                    href="https://www.linkedin.com/in/mohamed-mousa22"
                    class="font-semibold text-slate-700 text-primary"
                    target="_blank"
                    >Mohamed Ibrahim Mousa</a
                  >
                  for a better web.
                </div>
              </div>
              <div
                ...
                <ul
                  ...
                  <li class="nav-item">
                    <a
                      href="https://xn--zoh-3oa.my.canva.site/mohamed-mousa-portfolio"
                  ...
                  <li class="nav-item">
                    <a
                      href="https://github.com/MhmdMousa22"
                      class="block px-4 pt-0 pb-1 text-sm font-normal transition-colors ease-soft-in-out text-slate-500"
                      target="_blank"
                      >GitHub</a
                    >
